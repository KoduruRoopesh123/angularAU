...
@Component({
  selector: 'app-pre-insta-loan-upload',
  templateUrl: './pre-insta-loan-upload.component.html',
  styleUrls: ['./pre-insta-loan-upload.component.css']
})
export class PreInstaLoanUploadComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    //alert("sdgsr");
    this.radioModel="Low";
    var getDwhBasics = { action: 'getPreInstaLoanBasics', tabid: localStorage.getItem('tabid') };
      ...
      submitInstaLoan() {
       ...
       // var uploadEmiFile = { action: 'uploadEmiFile', tabid: localStorage.getItem('tabid') };
        //this.myForm.controls['file'].setValue(this.file);
          this.myForm.controls['action'].setValue('uploadPreInstaLoanFile');
