...
@Component({
  selector: 'app-emionpos',
  templateUrl: './emionpos.component.html',
  styleUrls: ['./emionpos.component.css'],
  providers: [NgbModalConfig, NgbModal]
})
export class EmionposComponent implements OnInit {
  ...
  //alert("sdgsr");
    this.radioModel="Low";
    var getEmiBasics = { action: 'getEmiBasics', tabid: localStorage.getItem('tabid') };
  ...
  submitEMI() {
   ...
   // var uploadEmiFile = { action: 'uploadEmiFile', tabid: localStorage.getItem('tabid') };
    //this.myForm.controls['file'].setValue(this.file);
      this.myForm.controls['action'].setValue('uploadEmiFile');
    ...
    if(this.channelSelected == "null"){
      this.myForm.controls['channel'].setValue('');
    }
    console.log(this.myForm.value)
